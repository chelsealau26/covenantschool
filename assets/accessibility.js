...
(function () {
  ...
  var ICON_A11Y =
    ...
    /* head */
    '<circle cx="17" cy="10" r="2.8" fill="' + BTN_RED + '"/>' +
    /* arms spread (horizontal bar) */
    '<line x1="10" y1="15.5" x2="24" y2="15.5"' +
      ' stroke="' + BTN_RED + '" stroke-width="2.4" stroke-linecap="round"/>' +
    /* torso */
    '<line x1="17" y1="13" x2="17" y2="20"' +
      ' stroke="' + BTN_RED + '" stroke-width="2.4" stroke-linecap="round"/>' +
    /* left leg */
    '<line x1="17" y1="20" x2="13" y2="26"' +
      ' stroke="' + BTN_RED + '" stroke-width="2.4" stroke-linecap="round"/>' +
    /* right leg */
    '<line x1="17" y1="20" x2="21" y2="26"' +
      ' stroke="' + BTN_RED + '" stroke-width="2.4" stroke-linecap="round"/>' +
    '</svg>';
