...
(function () {
  ...
  /* Wheelchair icon — fill-based, simple geometric shapes */
  var ICON_A11Y =
    '<svg viewBox="0 0 24 24" fill="white" aria-hidden="true">' +
    /* head */
    '<circle cx="10" cy="3.5" r="2.5"/>' +
    /* torso / seat back (vertical) */
    '<rect x="9" y="6" width="2" height="5" rx="1"/>' +
    /* seat (horizontal) */
    '<rect x="6" y="11" width="7" height="2" rx="1"/>' +
    /* lower leg */
    '<rect x="6" y="13" width="1.5" height="3.5" rx=".75"/>' +
    /* footrest bar */
    '<rect x="5.5" y="16" width="4.5" height="1.5" rx=".75"/>' +
    /* large rear wheel — donut ring via evenodd fill rule */
    '<path fill-rule="evenodd" d="' +
      'M3 18 a5 5 0 1 0 10 0 a5 5 0 1 0 -10 0 ' +   /* outer circle */
      'M5 18 a3 3 0 1 0 6 0 a3 3 0 1 0 -6 0' +       /* inner cutout */
    '"/>' +
    /* small front caster */
